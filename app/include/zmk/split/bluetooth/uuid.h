...
/* GLOVE80_DONGLE: Dedicated central-status channels */
#define ZMK_SPLIT_BT_CENTRAL_USB_STATUS_UUID ZMK_BT_SPLIT_UUID(0x00000008)
#define ZMK_SPLIT_BT_CENTRAL_BLE_STATUS_UUID ZMK_BT_SPLIT_UUID(0x00000009)
#define ZMK_SPLIT_BT_CENTRAL_LAYER_STATUS_UUID ZMK_BT_SPLIT_UUID(0x0000000A)
