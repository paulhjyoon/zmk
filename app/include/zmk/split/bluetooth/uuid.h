...
/* GLOVE80_DONGLE: New dedicated central-status channels */
#define ZMK_SPLIT_BT_CENTRAL_USB_STATUS_UUID ZMK_BT_SPLIT_UUID(0x00000007)
#define ZMK_SPLIT_BT_CENTRAL_BLE_STATUS_UUID ZMK_BT_SPLIT_UUID(0x00000008)
#define ZMK_SPLIT_BT_CENTRAL_LAYER_STATUS_UUID ZMK_BT_SPLIT_UUID(0x00000009)
